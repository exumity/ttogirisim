...
class UserApplicationAppliedJob extends Job
{
    ...
    public function handle()
    {
        ...
        $message=[
            ...
            "data"=>[
                "id"=>"application",
                "title"=>"Başvuruya Katılım",
                "message"=>$user->name_surname . " adlı kullanıcı, ".$this->applications->title." başlıklı başvuruyu tamamladı.",
