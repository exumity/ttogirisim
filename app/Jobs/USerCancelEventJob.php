...
class USerCancelEventJob extends Job
{
    ...
    public function handle()
    {
        ...
        $message=[
            ...
            "notification"=>[
                "title"=>"Etkinliten Ayrılma",
                "body"=>$user->name_surname." etkinlikten ayrıldı.",
            ...
            "data"=>[
                "id"=>"event",
                "title"=>"Etkinliten Ayrılma",
                "message"=>$user->name_surname . " adlı kullanıcı, ".$event->title." başlıklı etkinlikten ayrıldı.",
